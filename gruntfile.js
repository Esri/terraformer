...
module.exports = function (grunt) {
  grunt.initConfig({
    ...
    concat: {
      ...
      geostore: {
        src: ['<banner:meta.banner>', 'src/partials/geostore-head.js', 'src/helpers/browser/extend.js', 'src/helpers/browser/eventemitter.js', 'src/helpers/browser/stream.js', 'src/geostore.js', 'src/partials/geostore-tail.js' ],
