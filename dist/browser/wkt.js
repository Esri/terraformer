...
break;
case 16: this.$ = { "type": "Point", "coordinates": $[$0-2].data[0], "ref": { z: true } }; 
break;
case 17: this.$ = { "type": "Point", "coordinates": $[$0-3].data[0], "ref": { z: true, m: true } }; 
break;
case 18: this.$ = { "type": "Point", "coordinates": $[$0-2].data[0], "ref": { m: true } }; 
break;
...
break;
case 28: this.$ = { "type": "LineString", "coordinates": $[$0-2].data, "ref": { z: true } }; 
break;
case 29: this.$ = { "type": "LineString", "coordinates": $[$0-2].data, "ref": { m: true } }; 
break;
case 30: this.$ = { "type": "LineString", "coordinates": $[$0-3].data, "ref": { z: true, m: true } }; 
break;
case 31: this.$ = { "type": "LineString", "coordinates": [ ] }; 
break;
case 32: this.$ = { "type": "Polygon", "coordinates": $[$0-1].toJSON() }; 
break;
case 33: this.$ = { "type": "Polygon", "coordinates": $[$0-2].toJSON(), "ref": { z: true } }; 
break;
case 34: this.$ = { "type": "Polygon", "coordinates": $[$0-2].toJSON(), "ref": { m: true } }; 
break;
case 35: this.$ = { "type": "Polygon", "coordinates": $[$0-3].toJSON(), "ref": { z: true, m: true } }; 
break;
case 36: this.$ = { "type": "Polygon", "coordinates": [ ] }; 
break;
case 37: this.$ = { "type": "MultiPoint", "coordinates": $[$0-1].data }; 
break;
case 38: this.$ = { "type": "MultiPoint", "coordinates": $[$0-2].data, "ref": { z: true } }; 
break;
case 39: this.$ = { "type": "MultiPoint", "coordinates": $[$0-2].data, "ref": { m: true } }; 
break;
case 40: this.$ = { "type": "MultiPoint", "coordinates": $[$0-3].data, "ref": { z: true, m: true } }; 
break;
case 41: this.$ = { "type": "MultiPoint", "coordinates": [ ] } 
break;
case 42: this.$ = { "type": "MultiLineString", "coordinates": $[$0-1].toJSON() }; 
break;
case 43: this.$ = { "type": "MultiLineString", "coordinates": $[$0-2].toJSON(), "ref": { z: true } }; 
break;
case 44: this.$ = { "type": "MultiLineString", "coordinates": $[$0-2].toJSON(), "ref": { m: true } }; 
break;
case 45: this.$ = { "type": "MultiLineString", "coordinates": $[$0-3].toJSON(), "ref": { z: true, m: true } }; 
break;
case 46: this.$ = { "type": "MultiLineString", "coordinates": [ ] }; 
break;
case 47: this.$ = { "type": "MultiPolygon", "coordinates": $[$0-1].toJSON() }; 
break;
case 48: this.$ = { "type": "MultiPolygon", "coordinates": $[$0-2].toJSON(), "ref": { z: true } }; 
break;
case 49: this.$ = { "type": "MultiPolygon", "coordinates": $[$0-2].toJSON(), "ref": { m: true } }; 
break;
case 50: this.$ = { "type": "MultiPolygon", "coordinates": $[$0-3].toJSON(), "ref": { z: true, m: true } }; 
break;
