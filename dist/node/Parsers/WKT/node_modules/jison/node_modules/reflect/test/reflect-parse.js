...
function genExpr (body, blocks, filter) {
    return Pattern({
...
var xmlAnyName = Pattern({
        "type": "XMLAnyName"
    });
function xmlQualId (left, right, computed) {
    return Pattern({
...
function xmlFuncQualId (right, computed) {
    return Pattern({
...
function xmlAttrSel (id, computed) {
    return Pattern({
...
function xmlPointTag (contents) {
    return Pattern({
        "type": "XMLPointTag",
        "contents": contents
    });
}
function xmlStartTag (contents) {
    return Pattern({
        "type": "XMLStartTag",
        "contents": contents
    });
}
function xmlEndTag (contents) {
    return Pattern({
        "type": "XMLEndTag",
        "contents": contents
    });
}
function xmlEscape (expr) {
    return Pattern({
        "type": "XMLEscape",
        "expression": expr
    });
}
function xmlElt (contents) {
    return Pattern({
        "type": "XMLElement",
        "contents": contents
    });
...
function xmlPI (target, contents) {
    return Pattern({
...
function xmlComment (contents) {
    return Pattern({
        "type": "XMLComment",
        "contents": contents
    });
}
function xmlCdata (cdata) {
    return Pattern({
        "type": "XMLCdata",
        "contents": cdata
    });
...
assertGlobalStmt("try { } catch(e) { }", 10, { tryStatement: function(){ return 10 }});
assertGlobalStmt(";", 11, { emptyStatement: function(){ return 11 }});
assertGlobalStmt("debugger;", 12, { debuggerStatement: function(){ return 12 }});
assertGlobalStmt("42;", 13, { expressionStatement: function(){ return 13 }});
assertGlobalStmt("for (;;) break", forStmt(null, null, null, 14), { breakStatement: function(){ return 14 }});
assertGlobalStmt("for (;;) continue", forStmt(null, null, null, 15), { continueStatement: function(){ return 15 }});

assertBlockDecl("var x", "var", { variableDeclaration: function(kind){ return kind }});
//assertBlockDecl("let x", "let", { variableDeclaration: function(kind){ return kind }});
assertBlockDecl("const x", "const", { variableDeclaration: function(kind){ return kind }});
assertBlockDecl("function f() { }", "function", { functionDeclaration: function(){ return "function" }});

assertGlobalExpr("(x,y,z)", 1, { sequenceExpression: function(){ return 1 }});
assertGlobalExpr("(x ? y : z)", 2, { conditionalExpression: function(){ return 2 }});
assertGlobalExpr("x + y", 3, { binaryExpression: function(){ return 3 }});
assertGlobalExpr("delete x", 4, { unaryExpression: function(){ return 4 }});
assertGlobalExpr("x = y", 5, { assignmentExpression: function(){ return 5 }});
assertGlobalExpr("x || y", 6, { logicalExpression: function(){ return 6 }});
assertGlobalExpr("x++", 7, { updateExpression: function(){ return 7 }});
assertGlobalExpr("new x", 8, { newExpression: function(){ return 8 }});
assertGlobalExpr("x()", 9, { callExpression: function(){ return 9 }});
assertGlobalExpr("x.y", 10, { memberExpression: function(){ return 10 }});
assertGlobalExpr("(function(){ return { }})", 11, { functionExpression: function(){return 11 }});
assertGlobalExpr("[1,2,3]", 12, { arrayExpression: function(){ return 12 }});
assertGlobalExpr("({ x: y })", 13, { objectExpression: function(){ return 13 }});
assertGlobalExpr("this", 14, { thisExpression: function(){ return 14 }});
//assertGlobalExpr("#1={ }", 15, { graphExpression: function(){ return 15 }});
//assertGlobalExpr("#1={ self: #1# }", graphExpr(1, objExpr([{ key: ident("self"), value: 16 }])), { graphIndexExpression: function(){ return 16 }});
//assertGlobalExpr("[x for (x in y)]", 17, { comprehensionExpression: function(){ return 17 }});
//assertGlobalExpr("(x for (x in y))", 18, { generatorExpression: function(){ return 18 }});
//assertGlobalExpr("(function(){ return { yield 42 })", genFunExpr(null, [], blockStmt([exprStmt(19)])), { yieldExpression: function(){ return 19 }});
...
//assertGlobalExpr("[x for (y in z) for (x in y)]", compExpr(ident("x"), [3, 3], null), { comprehensionBlock: function(){ return 3 }});

//assertGlobalExpr("({ x: y } = z)", aExpr("=", 1, ident("z")), { objectPattern: function(){ return 1 }});
//assertGlobalExpr("({ x: y } = z)", aExpr("=", objPatt([2]), ident("z")), { propertyPattern: function(){ return 2 }});
//assertGlobalExpr("[ x ] = y", aExpr("=", 3, ident("y")), { arrayPattern: function(){ return 3 }});

//assertGlobalExpr("({a:x::y}) = foo", aExpr("=", singletonObjPatt("a", 1), ident("foo")), { xmlQualifiedIdentifier: function(){ return 1 }});
//assertGlobalExpr("({a:function::x}) = foo", aExpr("=", singletonObjPatt("a", 2), ident("foo")), { xmlFunctionQualifiedIdentifier: function(){ return 2 }});
//assertGlobalExpr("({a:@x}) = foo", aExpr("=", singletonObjPatt("a", 3), ident("foo")), { xmlAttributeSelector: function(){ return 3 }});
//assertGlobalExpr("({a:x.*}) = foo", aExpr("=", singletonObjPatt("a", dotExpr(ident("x"), 4)), ident("foo")), { xmlAnyName: function(){ return 4 }});

//assertGlobalExpr("(<x> </x>)()", callExpr(xmlElt([5, xmlText(" "), xmlEndTag([xmlName("x")])]), []), { xmlStartTag: function(){ return 5 }});
//assertGlobalExpr("(<x> </x>)()", callExpr(xmlElt([xmlStartTag([6]), xmlText(" "), xmlEndTag([6])]), []), { xmlName: function(){ return 6 }});
//assertGlobalExpr("(<x> </x>)()", callExpr(xmlElt([xmlStartTag([xmlName("x")]), 7, xmlEndTag([xmlName("x")])]), []), { xmlText: function(){ return 7 }});
//assertGlobalExpr("(<x> </x>)()", callExpr(xmlElt([xmlStartTag([xmlName("x")]), xmlText(" "), 8]), []), { xmlEndTag: function(){ return 8 }});
//assertGlobalExpr("(<x><![CDATA[hello, world]]></x>)()", callExpr(xmlElt([xmlStartTag([xmlName("x")]), 9, xmlEndTag([xmlName("x")])]), []), { xmlCdata: function(){ return 9 }});
//assertGlobalExpr("(<x><!-- hello, world --></x>)()", callExpr(xmlElt([xmlStartTag([xmlName("x")]), 10, xmlEndTag([xmlName("x")])]), []), { xmlComment: function(){ return 10 }});
